...
from back.core.embedings import Embeddings
from back.core.search import SearchIndex
from back.schemas.request import SimilarityRequest, UserTextSimilarityRequest
from config.envs import envs

paper_router = r = APIRouter()
redis_client = redis.from_url(envs.REDIS_URL)
...
async def get_papers(
    ...
    results = await redis_client.ft(envs.DEFAULT_PROVIDER).search(query)
