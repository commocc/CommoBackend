...
function sendMarkerData(lat, lng, text, selectedProperties) {
    ...
    $.ajax({
        ...
        headers: {
            ...
            "Access-Control-Allow-Origin": "https://api.xxxxx.xxx,https://xxxxx.xxxxx.xxxx",
    ...
    markersLayer.on("click", function (event) {
        ...
        if (feature.id.startsWith('signal')) {
            ...
            <div class="person">
                ...
                <br />
                <button type="button" class="button_alarm"><a href="https://xxxxxxxx/help/">Куда жаловаться?</a></button>
             </div>
            `;
            ...
            <div class="person">
                ...
                <br />
                <a href="https://xxxxx.xxxxxxx/d/g5CKOmB7k/sterlitamak">Подробный график</a>
                <br />
                <br />
                <button type="button" class="button_alarm"><a href="https://xxxx.com/help/">Куда жаловаться?</a></button>
             </div>
            `;
